#ifndef GOOGLEAPI_API_STATUS_H_
#define GOOGLEAPI_API_STATUS_H_
...
{
public:
  googleapi::util::error::Code code_;
  std::string msg_;
...
public:
   ...
   */
  Status() : code_(googleapi::util::error::OK) {}
   ...
   */
  Status(googleapi::util::error::Code code, const std::string& msg)
      : code_(code), msg_(msg) {}
   ...
   */
  bool ok() const { return code_ == googleapi::util::error::OK; }
   ...
   */
  googleapi::util::error::Code error_code() const { return code_; }
